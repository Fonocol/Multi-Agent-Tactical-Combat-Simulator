...
def spawn_agent():
    return [
        ScoutAgent(50, 30, radius=1.2),       # Proche safe zone
        SniperAgent(50, 80, radius=1.5,range_radius=20),      # Position avancée
        GuardAgent(15, 15, radius=1.8),       # Protection base
        SupportAgent(20, 20, radius=1.3),     # Support arrière
        HeavyAgent(50, 50, radius=2.2),       # Défense rapprochée
